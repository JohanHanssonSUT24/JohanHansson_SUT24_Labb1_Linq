...
namespace JohanHansson_SUT24_Labb1_Linq.Migrations
{
    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "SupplierId", "SupplierContactPerson", "SupplierEmail", "SupplierName", "SupplierPhone" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductDescription", "ProductName", "ProductPrice", "StockQuantity", "SupplierId" },
                values: new object[,]
                {
